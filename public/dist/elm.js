...
var $author$project$Gen$Route$Test = {$: 'Test'};
...
var $author$project$Gen$Params$Test$parser = $elm$url$Url$Parser$s('test');
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Test, $author$project$Gen$Params$Test$parser),
...
var $author$project$Gen$Model$Test = F2(
	function (a, b) {
		return {$: 'Test', a: a, b: b};
	});
var $author$project$Gen$Msg$Test = function (a) {
	return {$: 'Test', a: a};
};
...
var $author$project$Pages$Test$page = F2(
	function (shared, req) {
		return $author$project$Page$element(
			{init: $author$project$Pages$Test$init, subscriptions: $author$project$Pages$Test$subscriptions, update: $author$project$Pages$Test$update, view: $author$project$Pages$Test$view});
	});
...
var $author$project$Gen$Pages$pages = {
	...
	test: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Test$page, $author$project$Gen$Model$Test, $author$project$Gen$Msg$Test)
};
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Test':
			return $author$project$Gen$Pages$pages.test.init(_Utils_Tuple0);
		default:
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Test':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.test.subscriptions, params, model);
		default:
			var params = model_.a;
...
var $author$project$Gen$Pages$update = F2(
	function (msg_, model_) {
		...
		if (_v0.b.$ === 'Test') {
			...
			var params = _v1.a;
			var model = _v1.b;
			return A3($author$project$Gen$Pages$pages.test.update, params, msg, model);
		} else {
			return F3(
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Test':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.test.view, params, model);
		default:
			var params = model_.a;
